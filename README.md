...
<br>
Predict step, we can also utilize the 'best.model.pkl.local' and 'best.model.pkl.global' in model dir generated by edcnn to calculate the mean AUCs (0.944) of 24 experiments.
